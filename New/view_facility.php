...
session_start();
        ...
        $userData = $db->prepare("SELECT * FROM Animals");
        $userData->execute();
...
<script>
   ...
   var table= $('#animalTable').dataTable( {
            ...
            "sServerMethod": "GET",
            "aaSorting": [[ 0, "desc" ]],
            "sAjaxSource": "code/ajaxAnimalView.php",
			"aoColumns": [
			...
			"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
                ...
                $(row.find("td")['9']).html(
                    '<a type="button" href="edit_animal.php?id='+userID+'" class="btn btn-info btn-xs">	<i class="fa fa-edit"></i></a>&nbsp;<a href="javascript:;" onclick="del(\''+aData['8']+'\',\''+aData['1']+'\')" class="btn btn-primary btn-xs">	<i class="fa fa-trash-o"></i></a>'
                );
            }
