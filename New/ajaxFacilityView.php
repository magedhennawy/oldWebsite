 ...
 */
$aColumns = array( 'Exhibit', 'Location' ,'Biome', 'Capacity', 'Exhibit');
$asColumns =  array( 'Exhibit', 'Location' ,'Biome', 'Capacity', 'Exhibit');
$aaColumns =  array( 'Exhibit', 'Location' ,'Biome', 'Capacity', 'Exhibit');

/* Indexed column (used for fast and accurate table cardinality) */
$sIndexColumn = "Exhibit";
